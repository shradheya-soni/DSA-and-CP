<h2><a href="https://leetcode.com/problems/minimum-possible-maximum-waiting-time">Minimum Possible Maximum Waiting Time</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>You are given an integer array <code>demand</code>, where <code>demand[i]</code> is the amount of fuel required by the <code>i<sup>th</sup></code> car.</p>
